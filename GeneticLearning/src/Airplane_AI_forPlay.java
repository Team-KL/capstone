...
class Airplane_AI_forPlay extends Airplane{
	JPanel panel;
	...
	public Airplane_AI_forPlay(JPanel panel, int[] g) {
	...
	public void useRadar() {
		...
		for(int i = 0; i < points.length; i++) {
			double c = Math.pow(points[i].x - Simulation_forPlay.majorBullet.x, 2);
			double d = Math.pow(points[i].y - Simulation_forPlay.majorBullet.y, 2);
			...
			for(Bullet b : Simulation_forPlay.minorBullets) {
